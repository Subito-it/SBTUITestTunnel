...
if ARGV.length < 2
  ...
  puts 'Examples:'
  puts "  #{File.basename($0)} Examples/UIKit/SBTUITestTunnel.xcworkspace UIKit"
  puts "  #{File.basename($0)} Examples/UIKit/SBTUITestTunnel.xcworkspace UIKit_NoSwizzlingTests"
...
exit Build.build_ui_tests(project_path, scheme, simulator_name, simulator_os) ? 0 : 1
