...
class TestManager {
    lazy var testList: [any Test] = [
        ...
        NetworkTest.makeFetch(name: "executeDataTaskRequest3", url: URL(string: "https://postman-echo.com/get?param1=val1&param2=val2")),
        NetworkTest.makePost(name: "executePostDataTaskRequestWithLargeHTTPBody", url: URL(string: "https://postman-echo.com/post"), httpBody: String(repeating: "a", count: 20_000)),
        NetworkTest.makeUpload(name: "executeUploadDataTaskRequest", url: URL(string: "https://postman-echo.com/post"), data: "This is a test".data(using: .utf8)),
        NetworkTest.makeUpload(name: "executeUploadDataTaskRequest2", url: URL(string: "https://postman-echo.com/put"), data: "This is a test".data(using: .utf8), httpMethod: "PUT"),
        NetworkTest.makeBackgroundUpload(name: "executeBackgroundUploadDataTaskRequest", url: URL(string: "https://postman-echo.com/post"), data: "This is a test".data(using: .utf8)),
        NetworkTest.makePost(name: "executePostDataTaskRequestWithHTTPBody", url: URL(string: "https://postman-echo.com/post"), httpBody: "&param5=val5&param6=val6"),
        NetworkTest.makeUpload(name: "executeUploadDataTaskRequestWithHTTPBody", url: URL(string: "https://postman-echo.com/post"), data: "This is a test".data(using: .utf8), httpMethod: "POST", httpBody: true),
        NetworkTest.makeBackgroundUpload(name: "executeBackgroundUploadDataTaskRequestWithHTTPBody", url: URL(string: "https://postman-echo.com/post"), data: "This is a test".data(using: .utf8), httpBody: true),
        NetworkTest.makeRedirect(name: "executeRequestWithRedirect", url: URL(string: "https://postman-echo.com/redirect-to?url=http%3A%2F%2Fgoogle.com%2F")),
