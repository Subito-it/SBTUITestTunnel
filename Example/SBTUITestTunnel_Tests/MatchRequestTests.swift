...
class MatchRequestTests: XCTestCase {
    ...
    func testSimpleUrlAllMethods() {
        ...
        let result2 = request.dataTaskNetwork(urlString: "https://httpbin.org/post", httpMethod: "POST", httpBody: "&param5=val5&param6=val6")
    ...
    func testUrlWithQueryGetOnly() {
        ...
        let result5 = request.dataTaskNetwork(urlString: "https://httpbin.org/get?param1=val1&param2=val2")
        ...
        let result6 = request.dataTaskNetwork(urlString: "https://httpbin.org/get?param1=val1&param2=val2")
    ...
    func testPostWithBody() {
        ...
        let result = request.dataTaskNetwork(urlString: "https://httpbin.org", httpMethod: "POST", httpBody: "query QueryName")
        XCTAssert(request.isStubbed(result, expectedStubValue: 1))
    }
    ...
    func testPostWithJsonBody() {
        ...
        let result = request.dataTaskNetwork(urlString: "https://httpbin.org", httpMethod: "POST", httpBody: #"{ "key": "value" }"#)
        XCTAssert(request.isStubbed(result, expectedStubValue: 1))
    }
    
    func testPostWithBodyInverted() {
        let requestMatchInverted = SBTRequestMatch(url: "httpbin.org/post", query: [], method: "POST", body: "!QueryName")
        app.stubRequests(matching: requestMatchInverted, response: SBTStubResponse(response: ["stubbed": 1]))
        
        let containingBodyMatch = request.dataTaskNetwork(urlString: "https://httpbin.org/post", httpMethod: "POST", httpBody: "query QueryName")
        XCTAssertFalse(request.isStubbed(containingBodyMatch, expectedStubValue: 1))
        
        let notContainingBodyMatch = request.dataTaskNetwork(urlString: "https://httpbin.org/post", httpMethod: "POST", httpBody: "query AnotherQuery")
    ...
    func testInvertQueryGetOnly() {
        ...
        let result7 = request.dataTaskNetwork(urlString: "https://httpbin.org/get?param1=val1&param2=val2")
        ...
        let result8 = request.dataTaskNetwork(urlString: "https://httpbin.org/get?param1=val1&param2=val2")
